$.fn.jqueryautocompleteplus = function(data) {
  ...
  var onInputChange = data.onInputChange;
  var dataModifier = data.dataModifier;
  ...
  function successCallBack(response) {
    ...
    paginationIdTags = response.paginationIdTags;
  ...
  $('body')
    ...
    .on('input', '#' + self, function() {
      ...
      if (triggered) {
        ...
        onInputChange(query, paginationIdTags, dataModifier, successCallBack);
      } else {
        triggered = false;
